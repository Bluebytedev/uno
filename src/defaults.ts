...
export const CONNECTING_TIMEOUT_MS = parseInt(process.env.CONNECTING_TIMEOUT_MS || '300000')
...
export const QR_TIMEOUT_MS = parseInt(process.env.QR_TIMEOUT_MS || '120000')
